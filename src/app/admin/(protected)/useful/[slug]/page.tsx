        ...
        <div className="mb-6 flex flex-col gap-4 border-b border-slate-100 pb-6 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              ...
              target="_blank"
              style={{color: '#ffffff'}}
              className="inline-flex min-w-[160px] items-center justify-center rounded-2xl bg-slate-900 px-4 py-2.5 text-sm font-medium leading-none whitespace-nowrap transition hover:bg-slate-700"
            >
