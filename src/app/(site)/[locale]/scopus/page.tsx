...
function StageCard({
  ...
  return (
    <article className="relative overflow-hidden rounded-[30px] border border-[#ECE3DC] bg-white p-6 shadow-[0_10px_28px_rgba(17,17,17,0.05)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(17,17,17,0.08)] sm:p-7">
