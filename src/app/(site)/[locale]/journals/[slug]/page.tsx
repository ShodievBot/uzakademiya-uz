...
function StatCard({
  ...
  return (
    <div className="rounded-3xl border border-[#ECE3DC] bg-white p-5 shadow-[0_10px_28px_rgba(17,17,17,0.05)]">
      <div className="text-xs font-semibold uppercase tracking-[0.14em] text-[#B85A2B]">
        {label}
      </div>
      <div className="mt-3 text-2xl font-bold tracking-tight text-[#111111] sm:text-[30px]">{value}</div>
    </div>
  );
}
...
function InfoRow({
  ...
  return (
    <div className="flex items-start justify-between gap-4 border-b border-[#ECE3DC] py-3.5 last:border-b-0">
      <div className="text-sm font-medium text-[#787878]">{label}</div>
      <div className="max-w-[60%] break-words text-right text-sm leading-7 text-[#111111]">
        {value || '—'}
      </div>
    </div>
  );
...
function SourceLink({
  ...
  return (
    <a
      ...
      className="inline-flex rounded-2xl border border-[#ECE3DC] bg-white px-4 py-3.5 text-sm font-semibold text-[#111111] transition hover:-translate-y-0.5 hover:bg-[#FFF8F3]"
    >
      {label}
    </a>
  );
    ...
    <main className="pb-16">
      <section className="mx-auto max-w-7xl px-4 pt-10 sm:px-6 lg:px-8 lg:pt-12">
        <Link
          ...
          className="inline-block text-sm font-medium text-[#8A6A56] transition hover:-translate-y-0.5 hover:text-[#D05A1A]"
        >
          {copy.back}
        </Link>
      </section>
      ...
      <section className="mx-auto mt-6 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-[36px] border border-[#F1D8C8] bg-gradient-to-br from-[#FFF9F5] via-[#FFF4ED] to-white p-8 shadow-[0_16px_42px_rgba(17,17,17,0.07)] sm:p-10 lg:p-12">
          <div className="mb-5 flex flex-wrap gap-2.5">
            <span className="inline-flex rounded-full border border-[#FFD8C2] bg-white px-4 py-1.5 text-xs font-bold uppercase tracking-[0.18em] text-[#FF6C26] shadow-[0_8px_18px_rgba(255,108,38,0.08)]">
              {copy.badge}
            </span>
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
            <div>
              <h1 className="max-w-4xl text-4xl font-bold leading-[1.05] tracking-tight text-[#111111] sm:text-5xl lg:text-[58px]">
                {title}
              </h1>

              <p className="mt-3 text-sm leading-6 text-[#8A6A56] sm:text-[15px]">{altTitle}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1 lg:self-stretch">
              <StatCard
      ...
      <section className="mx-auto mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
          <div className="space-y-6">
            <section className="rounded-3xl border border-[#ECE3DC] bg-white p-6 shadow-[0_10px_28px_rgba(17,17,17,0.05)] sm:p-8">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <div className="rounded-[28px] border border-[#F3E5DB] bg-[#FFFCFA] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)]">
                  <div className="text-xs font-semibold uppercase tracking-[0.14em] text-[#B85A2B]">
