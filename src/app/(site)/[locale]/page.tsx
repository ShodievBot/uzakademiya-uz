...
function StatCard({
  ...
  return (
    <div className="rounded-[26px] border border-[#F0E2D8] bg-gradient-to-br from-white via-white to-[#FFF8F3] p-4 text-center shadow-[0_12px_30px_rgba(17,17,17,0.06)] sm:p-5">
      <div className="mx-auto h-1.5 w-10 rounded-full bg-[#FF6C26]" />
      <div className="mt-3 text-3xl font-bold leading-none text-[#111111] sm:text-4xl">
        {value}
      </div>
...
function QuickLinkCard({
  ...
  return (
    <Link
      href={href}
      className="group rounded-[30px] border border-[#ECE3DC] bg-[#FFF8F3] p-5 shadow-[0_10px_24px_rgba(17,17,17,0.04)] transition duration-200 hover:-translate-y-1.5 hover:border-[#FF6C26] hover:bg-white hover:shadow-[0_18px_36px_rgba(255,108,38,0.12)] sm:p-6"
    >
      <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-lg font-bold text-[#FF6C26] shadow-[0_8px_18px_rgba(17,17,17,0.05)] transition group-hover:scale-105 group-hover:bg-[#FFF2E9]">
        →
      </div>

      <h3 className="mt-5 text-xl font-bold leading-tight text-[#111111] transition group-hover:text-[#E85E1B]">
        {title}
      </h3>

      <p className="mt-3 text-sm leading-7 text-[#5B5B5B]">{text}</p>
    </Link>
  )
}
  ...
  return (
    <main className="pb-16">
      <section className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-8 lg:pt-12">
        <div className="rounded-[42px] border border-[#F1D8C8] bg-gradient-to-br from-[#FFF9F5] via-[#FFF4ED] to-white p-6 shadow-[0_24px_64px_rgba(17,17,17,0.07)] sm:p-8 lg:p-10">
          <div className="grid gap-8">
            <div className="mx-auto max-w-5xl text-center">
              ...
              <h1 className="mx-auto mt-6 max-w-4xl text-4xl font-bold leading-[1.05] tracking-tight text-[#111111] sm:text-5xl lg:text-[58px]">
                {content.title}
              </h1>

              <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-[#555555] sm:text-[17px]">
                {content.subtitle}
              </p>
              ...
              <form
                ...
                method="get"
                className="mx-auto mt-8 max-w-4xl rounded-[30px] border border-[#FFD8C2] bg-white/95 p-4 shadow-[0_18px_42px_rgba(255,108,38,0.10)] backdrop-blur"
              >
                <div className="flex flex-col gap-3 md:flex-row">
                  <input
                    ...
                    className="h-14 flex-1 rounded-2xl border border-[#ECE3DC] bg-[#FFFDFC] px-5 text-sm text-[#111111] outline-none placeholder:text-[#9A8F87] transition focus:border-[#FF6C26] focus:bg-white focus:shadow-[0_0_0_4px_rgba(255,108,38,0.10)]"
                  />
                  <button
                    type="submit"
                    className="inline-flex h-14 items-center justify-center rounded-2xl bg-[#FF6C26] px-7 text-sm font-bold text-white shadow-[0_14px_28px_rgba(255,108,38,0.24)] transition hover:-translate-y-0.5 hover:bg-[#E85E1B]"
                  >
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3 sm:gap-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-2xl border border-[#ECE3DC] bg-white px-6 py-3 text-sm font-semibold text-[#111111] transition hover:-translate-y-0.5 hover:bg-[#FFF8F3]"
                >
                  {content.contactUs}
                </Link>
              </div>
